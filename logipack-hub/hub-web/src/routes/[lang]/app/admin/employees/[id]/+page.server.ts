import { deleteMockEmployee, getMockEmployeeById } from "$lib/server/mockEmployees";
...
function fetchEmployeeDetail(id: string): DetailResult {
	...
	const office = primaryOfficeId ? getMockOfficeById(primaryOfficeId) : null;
	...
	return {
		...
		user: {
			name: employee.user_display_name ?? employee.full_name ?? employee.user_id,
